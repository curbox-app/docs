...
Curbox comes with a full blown scripting languge that allowas you to do math, run loops, conditionals, draw ui, search accessibility node etc. 
The app comes pre-shipped with multiple scripts that can be used to do block specific ui elements
