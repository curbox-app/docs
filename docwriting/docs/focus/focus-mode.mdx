...
7. **Set extra options** (optional)
   - Toggle **Let me quit mid-sessions** on if you want to be able to end the session early.
...
<Aside type="tip">
**Block All Except Selected** is great for deep work. Add only the apps you actually need — your notes app, a reference tool — and everything else is off-limits for the session.
</Aside>
