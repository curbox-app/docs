...
also if you kinda pro, you can easily add support for a browser especially if its chromium or firefox based. Read [CONTRIBUTING.md](https://github.com/nethical6/curbox/)
