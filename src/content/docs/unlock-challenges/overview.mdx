...
When a block triggers in Curbox, a pause screen appears. **Warning Screen** controls what happens on that screen — whether you can get past it, how hard that is, and how long it takes.
...
For example, if I've set the blocking mode to Time based with an allowed schedule between 2 pm and 6 pm every day. This screen won't show up if I access the app between 2 pm
and 9 pm. If I try to access the apps in this group anytime other than the schedule, this screen decides what has to be done.
...
## Custom Message
You can setup a message that appears when you open a blocked entity. Combining this together with delay timer, forces you to think before you mindlessly start scrolling.
Examples of good custom messages:
- Are you truly giving up your dreams to scroll 5 mins?
- That 5 mins costs you 100 days in 5 years btw