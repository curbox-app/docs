...
<Aside type="tip">
If you have trouble estimating a time limit, try **Reel Count Based** first. Setting a count of 10 or 20 videos gives you a very concrete sense of how much you are consuming — much more than a time number does.
</Aside>
