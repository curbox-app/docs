...
**Mindful Messages** shows a message you wrote to yourself as an overlay whenever you open a chosen app. It is a gentle nudge — not a block. You might write something like "Is this really important?" or "You wanted to read more instead." A moment of honest reflection can go a long way.
