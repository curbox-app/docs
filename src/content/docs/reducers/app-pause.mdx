...
| **Time Based** | Allows the app to be used only within a specific time window, like 10 PM to 7 AM every night. |
| **On each open** | Blocks the app each time you open it, irrespective of time or usage. |
